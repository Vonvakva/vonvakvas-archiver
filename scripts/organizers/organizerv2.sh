...
mv pfp/*Videos* "ia/${channel}_itemimage.jpg"

# Gathers videos, descriptions, subtitles and info.json inside ia/Videos
mv videos/* descricao/* info_json/* ia/Videos 2>/dev/null
if [[ -d subs ]]; then
    mkdir -p ia/Videos/subs
    mv subs/* ia/Videos/subs/ 2>/dev/null
fi
